			...
			<div class="single-page">
							<div class="single-page-artical">
						        	...
						        	{	
						        		...
						        		switch($value['type'])
						        		{
						        			case "miscellaneous" : $default_path = "miscellaneous.jpg"; break;
			        						case "movie" : $default_path = "movie.png"; break;
			        						case "travel" : $default_path = "travel.png"; break;
			        						case "food" : $default_path = "food.png"; break;
						        		}
						        	}
						        	else
						        	{
